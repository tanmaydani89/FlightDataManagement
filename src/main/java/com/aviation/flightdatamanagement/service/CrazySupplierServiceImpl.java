...
import com.aviation.flightdatamanagement.dto.supplier.CrazySupplierFlightDto;
import com.aviation.flightdatamanagement.dto.FlightResponseDto;
import com.aviation.flightdatamanagement.dto.supplier.SupplierRequest;
...
@Service("CrazySupplierServiceImpl")
@Primary
@Slf4j
public class CrazySupplierServiceImpl implements ISupplierService {
    ...
    @Autowired
    public CrazySupplierServiceImpl(RestTemplate restTemplate, @Value("${crazy.supplier.api.url}") String crazySupplierApiUrl) {
